            ...
            if record.date_to:
                ...
                domain.extend(
                    [
                        ...
                        # Existing record has end date and ranges overlap
                        "&",
                        ("date_to", "!=", False),
                        ("date_from", "<=", record.date_to),
                        "|",
                ...
                domain.extend(
                    [
                        "|",
                        # Existing record has no end date and starts on or after new record
                        "&",
                        ("date_to", "=", False),
                        ("date_from", ">=", record.date_from),
                        # Existing record has end date and starts before new record's start
                        "&",
                        ("date_to", "!=", False),
                        ("date_from", "<=", record.date_from),
                    ]
